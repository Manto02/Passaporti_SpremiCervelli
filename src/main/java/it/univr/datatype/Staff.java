...
public class Staff {
    ...
    public void insertDisponibility(Appointment appointment) throws SQLException {

        AppointmentDatabase appointmentDatabase = new AppointmentDatabase();
        try{
            appointmentDatabase.insert(appointmentDatabase.getTableName(), AppointmentEnum.getDatabaseColumns(), appointment.appointment,
                    appointment.appointment_type, this.getLuogo(), appointment.date, appointment.time);
